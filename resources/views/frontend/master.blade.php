...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('frontend_asset') }}/vendor/bootstrap-icons/bootstrap-icons.css">
        ...
        <nav class="navbar navbar-expand-xl">
            <div class="container-fluid px-3 px-xl-5">
                ...
                <a class="navbar-brand" href="{{ route('index') }}">
                    <img class="light-mode-item navbar-brand-item" src="{{ asset('frontend_asset') }}/images/logo.svg"
                        alt="logo">
                    <img class="dark-mode-item navbar-brand-item"
                        src="{{ asset('frontend_asset') }}/images/logo-light.svg" alt="logo">
                </a>
                <!-- Logo END -->
                            ...
                            <div class="dropdown-menu dropdown-menu-end" data-bs-popper="none">
                                <div class="row p-4">
                                    ...
                                    <div class="col-xl-6 col-xxl-3 mb-3">
                                        ...
                                        <hr>
                                        <!-- Image -->
                                        <img src="{{ asset('frontend_asset') }}/images/element/14.svg"
                                            alt="">
                                        ...
                                        <div class="row g-2 justify-content-center mt-3">
                                            ...
                                            <div class="col-6 col-sm-4 col-xxl-6">
                                                <a href="#"> <img
                                                        src="{{ asset('frontend_asset') }}/images/client/google-play.svg"
                                                        class="btn-transition" alt="google-store"> </a>
                                            </div>
                                            <!-- App store button -->
                                            <div class="col-6 col-sm-4 col-xxl-6">
                                                <a href="#"> <img
                                                        src="{{ asset('frontend_asset') }}/images/client/app-store.svg"
                                        ...
                                        <div class="alert alert-success alert-dismissible fade show mt-2 mb-0 rounded-3"
                                            ...
                                            <div class="avatar avatar-xs me-2">
                                                <img class="avatar-img rounded-circle"
                                                    src="{{ asset('frontend_asset') }}/images/avatar/09.jpg"
                                                    alt="avatar">
                                            </div>
                                            <!-- Info -->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end min-w-auto">
                                    <li><a class="dropdown-item" href="#"><i
                                                class="text-warning fa-fw bi bi-life-preserver me-2"></i>Support</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#"><i
                                                class="text-danger fa-fw bi bi-card-text me-2"></i>Documentation</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                        ...
                        <div class="nav my-3 my-xl-0 px-4 flex-nowrap align-items-center">
                            <div class="nav-item w-100">
                                <form class="position-relative">
                                    ...
                                    <button
                                        class="bg-transparent p-2 position-absolute top-50 end-0 translate-middle-y border-0 text-reset"
                                        type="submit">
                        ...
                        <div class="card">
                            <div class="mb-3">
                                <div class="navbar-nav d-none d-lg-inline-block">
                                    @guest('student')
                                        <a href="{{ route('sign.in') }}" class="btn btn-danger-soft mb-0">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3">
                    ...
                    <a class="me-0" href="index.html">
                        <img class="light-mode-item h-40px" src="{{ asset('frontend_asset') }}/images/logo.svg"
                            alt="logo">
                        <img class="dark-mode-item h-40px" src="{{ asset('frontend_asset') }}/images/logo-light.svg"
                            alt="logo">
                    </a>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="row g-2 mt-2">
                        ...
                        <div class="col-6 col-sm-4 col-md-3 col-lg-6">
                            <a href="#"> <img src="{{ asset('frontend_asset') }}/images/client/google-play.svg"
                                    alt=""> </a>
                        </div>
                        <!-- App store button -->
                        <div class="col-6 col-sm-4 col-md-3 col-lg-6">
                            <a href="#"> <img src="{{ asset('frontend_asset') }}/images/client/app-store.svg"
                                    alt="app-store"> </a>
                        </div>
                    </div> <!-- Row END -->
                </div>
                ...
                <div class="container px-0">
                    <div class="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
                        ...
                        <div class="text-body text-primary-hover"> Copyrights ©2024 Eduport. Build by <a
                                href="https://www.stackbros.in/" target="_blank" class="text-body">StackBros</a>
                        </div>
                        <!-- copyright links-->
                                    ...
                                    <div class="dropup mt-0 text-center text-sm-end">
                                        ...
                                        <ul class="dropdown-menu min-w-auto" aria-labelledby="languageSwitcher">
                                            <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                                        src="{{ asset('frontend_asset') }}/images/flags/uk.svg"
                                                        alt="">English</a></li>
                                            <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                                        src="{{ asset('frontend_asset') }}/images/flags/gr.svg"
                                                        alt="">German </a></li>
                                            <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                                        src="{{ asset('frontend_asset') }}/images/flags/sp.svg"
                                                        alt="">French</a></li>
                                        </ul>
                                    </div>
                                </li>
