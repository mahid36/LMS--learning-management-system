...
<!-- Mirrored from stackbros.in/eduport/landing/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Mar 2026 20:22:07 GMT -->
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" href="{{asset('frontend_asset')}}/images/favicon.ico">
	...
	<!-- Plugins CSS -->
	<link rel="stylesheet" type="text/css" href="{{asset('frontend_asset')}}/vendor/font-awesome/css/all.min.css">
	<link rel="stylesheet" type="text/css" href="{{asset('frontend_asset')}}/vendor/bootstrap-icons/bootstrap-icons.css">
	<link rel="stylesheet" type="text/css" href="{{asset('frontend_asset')}}/vendor/tiny-slider/tiny-slider.css">
	<link rel="stylesheet" type="text/css" href="{{asset('frontend_asset')}}/vendor/glightbox/css/glightbox.css">
...
<header class="navbar-light navbar-sticky header-static">
						...
						<div class="dropdown-menu dropdown-menu-end" data-bs-popper="none">
							<div class="row p-4">
								...
								<div class="col-xl-6 col-xxl-3 mb-3">
									...
									<hr>
									<!-- Image -->
									<img src="{{asset('frontend_asset')}}/images/element/14.svg" alt="">

									<!-- Download button -->
									<div class="row g-2 justify-content-center mt-3">
										<!-- Google play store button -->
										<div class="col-6 col-sm-4 col-xxl-6">
											<a href="#"> <img src="{{asset('frontend_asset')}}/images/client/google-play.svg" class="btn-transition" alt="google-store"> </a>
										</div>
										<!-- App store button -->
										<div class="col-6 col-sm-4 col-xxl-6">
											<a href="#"> <img src="{{asset('frontend_asset')}}/images/client/app-store.svg" class="btn-transition" alt="app-store"> </a>
										</div>
									</div>
								</div>
								...
								<div class="col-12">
									<div class="alert alert-success alert-dismissible fade show mt-2 mb-0 rounded-3" role="alert">
										...
										<div class="avatar avatar-xs me-2">
											<img class="avatar-img rounded-circle" src="{{asset('frontend_asset')}}/images/avatar/09.jpg" alt="avatar">
										</div>
										<!-- Info -->
    ...
    <li class="nav-item ms-2 dropdown">
        ...
        <span class="position-absolute top-0 start-100 translate-middle badge rounded-circle bg-dark mt-2 ms-n3">2</span>
        ...
        <div class="dropdown-menu dropdown-animation dropdown-menu-end dropdown-menu-size-md p-0 shadow-lg border-0">
            <div class="card bg-transparent shadow-none">
                ...
                <div class="card-footer bg-transparent border-top py-3 text-center d-flex justify-content-between">
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end min-w-auto">
            <li><a class="dropdown-item" href="#"><i class="text-warning fa-fw bi bi-life-preserver me-2"></i>Support</a></li>
            <li><a class="dropdown-item" href="#"><i class="text-danger fa-fw bi bi-card-text me-2"></i>Documentation</a></li>
        </ul>
    </li>
</ul>
...
<div class="nav my-3 my-xl-0 px-4 flex-nowrap align-items-center">
    <div class="nav-item w-100">
        <form class="position-relative">
            ...
            <button class="bg-transparent p-2 position-absolute top-50 end-0 translate-middle-y border-0 text-reset" type="submit">
...
<!-- Signout button  -->
			...
			<div class="dropdown ms-1 ms-lg-0">
				<a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
					<img class="avatar-img rounded-circle" src="{{asset('frontend_asset')}}/images/avatar/01.jpg" alt="avatar">
				</a>
					...
					<li class="px-3 mb-3">
						<div class="d-flex align-items-center">
							...
							<div class="avatar me-3">
								<img class="avatar-img rounded-circle shadow" src="{{asset('frontend_asset')}}/images/avatar/01.jpg" alt="avatar">
							</div>
							<div>
		...
		<div class="row g-4">
			...
			<div class="col-lg-3">
				...
				<a class="me-0" href="index.html">
					<img class="light-mode-item h-40px" src="{{asset('frontend_asset')}}/images/logo.svg" alt="logo">
					<img class="dark-mode-item h-40px" src="{{asset('frontend_asset')}}/images/logo-light.svg" alt="logo">
				</a>
			...
			<div class="col-lg-3">
				...
				<div class="row g-2 mt-2">
					...
					<div class="col-6 col-sm-4 col-md-3 col-lg-6">
						<a href="#"> <img src="{{asset('frontend_asset')}}/images/client/google-play.svg" alt=""> </a>
					</div>
					<!-- App store button -->
					<div class="col-6 col-sm-4 col-md-3 col-lg-6">
						<a href="#"> <img src="{{asset('frontend_asset')}}/images/client/app-store.svg" alt="app-store"> </a>
					</div>
				</div> <!-- Row END -->
			</div>
			<!-- Widget 3 END -->
							...
							<li class="list-inline-item">
								...
								<div class="dropup mt-0 text-center text-sm-end">
									...
									<ul class="dropdown-menu min-w-auto" aria-labelledby="languageSwitcher">
										<li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="{{asset('frontend_asset')}}/images/flags/uk.svg" alt="">English</a></li>
										<li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="{{asset('frontend_asset')}}/images/flags/gr.svg" alt="">German </a></li>
										<li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="{{asset('frontend_asset')}}/images/flags/sp.svg" alt="">French</a></li>
									</ul>
								</div>
							</li>
...
<!-- Mirrored from stackbros.in/eduport/landing/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Mar 2026 20:22:48 GMT -->
</html>
