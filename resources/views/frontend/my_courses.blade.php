                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <!-- Image -->
                                        <div class="w-100px">
                                            <img src="{{ asset('uploads/course/preview') }}/{{ $my->rel_to_course->preview }}"
                                                class="rounded" alt="">
                                        </div>
                                        <div class="mb-0 ms-2">
                                            <!-- Title -->
                                            <h6 class="table-responsive-title"><a href="#">{{$my->rel_to_course->course_title}}</a></h6>
                                            <!-- Info -->
                                ...
                                <!-- Table data -->
                                <td>{{ $my->rel_to_course->total_lecture }}</td>
