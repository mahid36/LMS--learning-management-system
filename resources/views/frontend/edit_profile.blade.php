    ...
    <div class="col-xl-9">
        ...
        <div class="card bg-transparent border rounded-3">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row g-4" method="POST" action="{{ route('update.profile') }}" enctype="multipart/form-data">
                    @csrf
                    <!-- Profile picture -->
                    ...
                    <div class="col-lg-6">
                        ...
                        @if (session('wrng_pass'))
                        <strong class="text-danger">{{ session('wrng_pass') }}</strong>
                        @endif
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
