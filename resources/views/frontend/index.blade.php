	...
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-lg-8 mx-auto text-center">
				<h2 class="fs-1">Our Popular Courses</h2>
						...
						<div class="card shadow h-100">
							...
							<div class="card-footer pt-0 pb-3">
								...
								<div class="d-flex justify-content-between">
									...
									<span class="h6 fw-light mb-0"><i class="fas fa-table text-orange me-2"></i>{{ $course->total_lecture }} lectures</span>
								</div>
							</div>
						</div>
					</div>
    ...
    <div class="row g-4">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3">
            <div class="card shadow h-100">
                ...
                <!-- Image -->
                <img src="{{ asset('uploads/course/preview/'.$course->preview) }}"
                ...
                <div class="card-body pb-0">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        <span class="badge bg-success bg-opacity-10 text-success">
                            {{ $course->rel_to_level->level_name ?? 'Beginner' }}
                        </span>
                    </div>
